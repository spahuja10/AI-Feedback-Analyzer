...
def download_nltk_data():
    ...
    try:
        ...
        try:
            ...
            st.error(f"Failed to download NLTK data: {e_specific}")
            return False
    return True

# Execute the download before any other NLTK calls
...
# Load models immediately so they are ready
...
default_action = "will you, by when, deadline, commit, accountability, measure, first step, your plan, ownership"
