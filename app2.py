...
# -------------------------------
# Transcript Scoring Function (UPDATED)
# -------------------------------
def analyze_transcript(transcript):
    ...
    def is_open_question(q):
        ...
        return any(re.match(p, q_lower) for p in open_question_patterns)
    ...
    # -----------------------------------------------------
    # NEW: QUESTION STACKING → Separate Metric
    # -----------------------------------------------------
    ...
    # -----------------------------------------------------
    # RETURN ALL METRICS INCLUDING QUESTION STACKING
    # -----------------------------------------------------
    return {
